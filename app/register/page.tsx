        ...
        <div className="fixed container px-[5vw] mx-auto inset-0 bg-black/60 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full relative">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              You’ve successfully registered under {agentName}’s referral! Start
              exploring RAD5 Brokers Network.
            </p>
            <div className="flex justify-end space-x-4">
              <Link href="/">
                <Button className="bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 absolute top-2 right-2">
                  x
                </Button>
              </Link>
            </div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 min-h-[600px] rounded-lg overflow-hidden shadow-xl">
          <div className="hidden lg:block bg-[url(/signupbg03.jpg)] bg-cover bg-center bg-no-repeat relative">
            ...
            <div className="absolute z-10 text-white p-6 space-y-4">
              ...
              <h1 className="text-4xl font-bold">Join RBN with {agentName}</h1>
              <p className="text-sm max-w-xs">
                Register through {agentName}’s referral to join RAD5 Brokers
                Network. Refer students to elite tech programs and start earning
                commissions today.
              </p>
            </div>
          </div>
