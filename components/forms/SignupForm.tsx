...
export default function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Registering agent via:", `${apiBaseUrl}/agent/register`);
      ...
      console.log("SignUp Response:", successResult);
      const referralLink =
        successResult.data.referralLink ||
        `https://rad-5-broker-network.vercel.app/register/agent/${successResult.data.agentData.sharableLink}`;
      console.log("Saving referral link:", referralLink);
      localStorage.setItem("rbn_referral_link", referralLink);
      console.log(
        "Stored referral link:",
        localStorage.getItem("rbn_referral_link")
      );
