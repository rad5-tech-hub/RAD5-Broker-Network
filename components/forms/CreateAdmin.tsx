...
export default function CreateAdmin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Submit event fired with form data:", formData); // Debug submit
    setIsLoading(true);
    ...
    try {
      ...
      const apiBaseUrl =
        process.env.NEXT_PUBLIC_API_URL || "https://rbn.bookbank.com.ng/api/v1";
      const endpoint = `${apiBaseUrl}/admin/create`;
      console.log("Fetching from endpoint:", endpoint); // Debug endpoint
      ...
      console.log("API Response:", result); // Debug result
      ...
      setIsLoading(false);
      console.log("Loading state reset"); // Debug finally
    }
  };
